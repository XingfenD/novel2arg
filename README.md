...
- Documentation: **[English](docs/README.md)** · **[中文](docs/README_zh.md)**
- Entry point: [SKILL.md](SKILL.md) — workflow router and dispatch contract
- Changelog: [docs/CHANGELOG.md](docs/CHANGELOG.md)

Install by sending this repository URL to your agent (Claude Code / opencode / Codex) with
