...
- Docs prose (README, USAGE, …): one language per file; translations live in sibling files. The README and USAGE pairs are Chinese-default and live in `docs/` (`docs/README.md` / `docs/README_en.md`, `docs/USAGE.md` / `docs/USAGE_en.md`) — never at the repo root. No bilingual duplication inside a paragraph.
