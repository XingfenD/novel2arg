...
- Docs prose (README, USAGE, …): one language per file; translations live in `_zh` sibling files (`README.md` / `README_zh.md`). No bilingual duplication inside a paragraph.
