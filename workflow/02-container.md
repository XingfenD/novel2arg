...
**Record on the GDD cover page:** primary container, central interaction implementation (A/B: search engine in references/project-structure.md §4; C: cross-site hard links plus obfuscated directory names; D: §5 `gate.js` multi-field gate plus archive list page), secondary container and its nesting location.
