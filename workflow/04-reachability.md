...
4. Search hit — keyword → hidden page
...
- **Keyword solvability.** Every key in `data/keywords.src.json` appears verbatim in the copy of a reachable page. A keyword that appears nowhere makes its puzzle unsolvable.
