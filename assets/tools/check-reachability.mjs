...
import CONFIG from './config.mjs';   // shared conventions (credTable / entry / unlockEnd / solver)
...
try {
  cpSync(ROOT, site, { recursive: true, filter: (src) => !['.git', 'node_modules'].some((d) => src.includes(`/${d}`)) });
