...
//    still unlocks with check-reachability.mjs (a rehearsal copy with the values injected). See tooling.md §3.
...
//    while the real browser shows the document locked. Use a session cookie (components.md §2–§3,
