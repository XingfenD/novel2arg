...
- `about.html` 是入口的“关于”页，介绍项目源于 novel2arg 技能；内容写在虚构之外，不要放剧情或答案。
...
| 路径 | 说明 |
|---|---|
| `index.html` | 入口外壳（M9）：身份赋予 + 进入按钮；规则说明只在虚构确有必要时出现 |
| `about.html` | 入口链接的“关于”页：介绍项目源于 novel2arg；写在虚构之外，不放剧情与答案 |
