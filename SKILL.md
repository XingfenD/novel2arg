...
| 3 Write the GDD | workflow/03-gdd.md | `docs/gdd.md`, eight sections | examples/gdd-excerpt.md | subagent → user review checkpoint |
...
- **references/structure/tooling.md**: check cadence, the shared `tools/config.mjs` knobs, and the five manual methods no static checker replaces. Required reading at step 8.
